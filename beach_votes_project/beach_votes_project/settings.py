"""
Django settings for beach_votes_project project.
...
SECRET_KEY = 'li00d2e-a*j$p3$=anf4&7c4r91j@#(pu9$8tou0nguk#l5s8a'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['stevengarcia.pythonanywhere.com']
...
ROOT_URLCONF = 'beach_votes_project.urls'
...
WSGI_APPLICATION = 'beach_votes_project.wsgi.application'
