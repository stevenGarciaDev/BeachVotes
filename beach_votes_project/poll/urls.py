...
urlpatterns = [
    ...
    url(r'^(?P<poll_id>[0-9]+)/(?P<user_id>[0-9]+)/$', views.view_poll, name='view_poll'),
    url(r'^category/(?P<category>[0-9]+)/$', views.view_category, name='view_category'),
    url(r'^search_polls', views.search_polls, name='search_polls'),
    url(r'^view_all_polls', views.view_all_polls, name='view_all_polls'),
